                    ...
                    promptTemplate:
                        useOnlineData === false
                            ? promptTemplate.length === 0
                                ...
                                : promptTemplate
                            : promptTemplate.length === 0
                            ? ">>> If there isn't enough information below, search data on the Internet."
                            : promptTemplate + " If there isn't enough information below, search data on the Internet.",
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>GTI X HKEX WORKSHOP</h1>
